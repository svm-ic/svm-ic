...
export default function App() {
  ...
  return (
 <>
      <div className={`fixed inset-0 z-[100] bg-[#0B5ED7] flex flex-col items-center justify-center transition-opacity duration-700 ${loaded ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <div className="w-24 h-24 bg-white/10 backdrop-blur-md rounded-3xl flex items-center justify-center mb-8 shadow-2xl ring-1 ring-white/20">
